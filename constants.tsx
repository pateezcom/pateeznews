...
export const NEWS_FEED: NewsItem[] = [
  ...
  },
  {
    ...
    summary: 'Bu hafta PateezCast\'te yapay zekanın gündelik hayatımızı nasıl değiştirdiğini ve gelecekte bizi nelerin beklediğini konuşuyoruz. Kulaklıklarınızı takın!',
