        ...
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-palette-beige flex flex-col items-center justify-center p-8 text-center">
                    <div className="w-16 h-16 bg-palette-red rounded-2xl flex items-center justify-center text-white shadow-xl mb-6">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-palette-red text-white rounded-xl font-bold hover:bg-red-700 transition-colors"
                    >
                        Sayfayı Yenile
                    </button>
                    {process.env.NODE_ENV === 'development' && (
                        <pre className="mt-8 p-4 bg-black/5 rounded-lg text-left text-xs overflow-auto max-w-full">
