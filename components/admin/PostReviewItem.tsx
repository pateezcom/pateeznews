            ...
            <div className="flex-1 p-5 space-y-6">
                ...
                <div className="flex items-center justify-between border-b border-palette-tan/15 pb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[11px] font-bold text-palette-tan/50 tracking-wide">{t('admin.post.review_desc_alt')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                    <div className="md:col-span-10 space-y-1.5">
                        <label className="text-[13px] font-black text-palette-tan ml-1">{t('admin.post.product_name')}</label>
                        <div className="flex items-center gap-3">
                            {showBlockNumbers && (
                            ...
                            <input
                                ...
                                placeholder={t('admin.post.product_placeholder')}
                            />
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="md:col-span-4 space-y-2">
                        <label className="text-[13px] font-black text-palette-tan ml-1 uppercase tracking-wider">{t('admin.post.review_image')}</label>
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <Quill
                                            ...
                                            placeholder={t('admin.post.verdict_placeholder')}
