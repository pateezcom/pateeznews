...
const PUBLISHERS: Publisher[] = [
  {
    ...
    posts: '14K',
    verified: true,
    description: 'En son teknoloji haberleri, cihaz incelemeleri ve gelecek vizyonu.'
  },
  {
    id: 'p2',
    name: 'Buzz Culture',
    category: 'Kültür & Sanat',
    avatar: 'https://picsum.photos/seed/culture/100',
    cover: 'https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&q=80&w=800',
    followers: '850K',
    posts: '8.2K',
    verified: true,
    description: 'Dünya kültürleri, sanat etkinlikleri ve yaşam tarzı trendleri.'
  },
  {
    id: 'p3',
    name: 'Buzz History',
    category: 'Tarih',
    avatar: 'https://picsum.photos/seed/history/100',
    cover: 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?auto=format&fit=crop&q=80&w=800',
    followers: '620K',
    posts: '5.1K',
    verified: true,
    description: 'İnsanlık tarihinin gizemleri, antik medeniyetler ve büyük keşifler.'
  },
  {
    id: 'p4',
    name: 'Buzz Gaming',
    category: 'Oyun',
    avatar: 'https://picsum.photos/seed/gaming/100',
    cover: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?auto=format&fit=crop&q=80&w=800',
    followers: '2.1M',
    posts: '22K',
    verified: true,
    description: 'E-spor dünyası, oyun incelemeleri ve sızıntılar.'
  },
  {
    id: 'p5',
    name: 'Buzz Space',
    category: 'Bilim',
    avatar: 'https://picsum.photos/seed/space/100',
    cover: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800',
    followers: '940K',
    posts: '6.4K',
    verified: true,
    description: 'Uzay araştırmaları, astronomi ve fizik dünyasından yenilikler.'
  },
  {
    id: 'p6',
    name: 'Buzz Nature',
    ...
    cover: 'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?auto=format&fit=crop&q=80&w=800',
    followers: '1.5M',
    posts: '12K',
    verified: true,
    description: 'Vahşi yaşam, ekoloji ve gezegenimizin korunmasına dair her şey.'
  }
];
          ...
          {PUBLISHERS.map((pub) => (
            ...
            >
              ...
              <div className="px-6 relative flex flex-col">
                 ...
                 <p className="text-xs text-gray-500 font-bold mb-4">@{pub.name.toLowerCase().replace(' ', '')}</p>
