...
const PublisherEditProfile: React.FC<PublisherEditProfileProps> = ({ name, onBack }) => {
  ...
  return (
    <div className="animate-in bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden mb-10">
      ...
      <div className="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white/80 backdrop-blur-md z-30">
        <div className="flex items-center gap-4">
          <button 
            onClick={onBack}
            className="p-2.5 bg-gray-50 text-gray-400 rounded-xl hover:text-gray-900 transition-all border border-transparent hover:border-gray-100 active:scale-90"
          >
            <ArrowLeft size={20} />
          </button>
          <div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2 group">
                ...
                <div className="relative h-48 rounded-2xl overflow-hidden border-2 border-dashed border-gray-200 bg-gray-50 group-hover:border-blue-400 transition-all">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <button className="p-3 bg-white rounded-xl shadow-xl text-gray-900 hover:scale-110 transition-transform">
                      <Camera size={24} />
                    </button>
                    <span className="mt-3 text-[10px] font-black text-gray-900 uppercase tracking-widest bg-white/80 backdrop-blur-sm px-3 py-1 rounded-lg">Değiştir</span>
                  </div>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="relative aspect-square rounded-2xl overflow-hidden border-2 border-dashed border-gray-200 bg-gray-50 group-hover:border-blue-400 transition-all">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-xl text-sm font-bold focus:bg-white focus:border-blue-500 focus:outline-none transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    rows={4}
                    className="w-full p-4 bg-gray-50 border border-gray-100 rounded-xl text-sm font-bold focus:bg-white focus:border-blue-500 focus:outline-none transition-all resize-none"
                  />
      ...
      {/* Warning Area */}
      <div className="m-8 p-6 bg-amber-50 rounded-2xl border border-amber-100 flex items-start gap-4">
