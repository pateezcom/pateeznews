...
const CategoryDetail: React.FC<CategoryDetailProps> = ({ category, onBack, onNewsSelect }) => {
  ...
  return (
    <div className="animate-in bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-10">
      ...
      <div className="p-8 md:p-10 border-b border-gray-50 bg-gray-50/30">
        <div className="flex items-center justify-between mb-8">
           <button 
             onClick={onBack}
             className="p-2.5 bg-white border border-gray-200 text-gray-400 rounded-xl hover:text-blue-600 hover:border-blue-100 transition-all shadow-sm group active:scale-90"
           >
             <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
           </button>
           
           <div className="flex items-center gap-2">
              <button className="p-2.5 bg-white border border-gray-200 text-gray-400 rounded-xl hover:text-gray-900 transition-all shadow-sm">
                <Filter size={18} />
              </button>
              <button className="p-2.5 bg-white border border-gray-200 text-gray-400 rounded-xl hover:text-gray-900 transition-all shadow-sm">
                <TrendingUp size={18} />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
           ...
           <div className="flex items-center gap-4 py-4 px-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
      ...
      <div className="p-6 md:p-10 bg-gray-50/20">
         {categoryNews.length > 0 ? (
           ...
           <div className="max-w-md mx-auto text-center py-24 bg-white rounded-3xl border border-gray-100 shadow-sm">
              ...
              <button 
                onClick={onBack}
                className="mt-8 px-8 py-3 bg-gray-900 text-white rounded-xl font-black text-[11px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg active:scale-95"
              >
                Geri Dön
              </button>
           </div>
         ...
         <div className="max-w-xl mx-auto text-center">
            ...
            <div className="flex gap-2">
               <input 
                 ...
                 className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm font-bold focus:bg-white focus:border-blue-400 focus:outline-none transition-all"
               />
               <button className="px-6 py-3 bg-blue-600 text-white rounded-xl font-black text-[11px] uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
                 Kaydol
               </button>
            </div>
         </div>
