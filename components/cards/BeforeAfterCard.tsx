...
const BeforeAfterCard: React.FC<BeforeAfterCardProps> = ({ data }) => {
  ...
  return (
    <div className="mt-4 space-y-4">
      ...
      <div className="relative w-full h-[450px] rounded-lg overflow-hidden shadow-2xl select-none group border border-gray-100">
        ...
        >
          {/* Handle Circle */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.4)] transform active:scale-95 transition-transform border-4 border-white/20">
        ...
        <div className="absolute bottom-6 right-6 z-10 pointer-events-none transition-opacity duration-300" style={{ opacity: sliderPosition > 90 ? 0 : 1 }}>
         ...
         {/* Hint overlay */}
         <div className="absolute top-6 left-1/2 -translate-x-1/2 bg-black/30 backdrop-blur-sm px-3 py-1 rounded-full border border-white/10 pointer-events-none">
