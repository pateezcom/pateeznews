         ...
         <div className="relative h-[240px] w-full bg-gray-900 group">
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <span className="inline-block px-3 py-1 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-full mb-2">
                    İnceleme
                  </span>
                  <h3 className="text-3xl font-black leading-none tracking-tight">{productName}</h3>
                </div>
                <div className={`w-20 h-20 rounded-lg ${scoreBg} ${scoreBorder} border-4 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(0,0,0,0.3)] backdrop-blur-md transform rotate-3`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
               ...
               <div className="bg-emerald-50/50 rounded-lg p-5 border border-emerald-100">
                  <div className="flex items-center gap-2 mb-4">
                     <div className="bg-emerald-500 p-1 rounded-full text-white"><Check size={14} strokeWidth={4} /></div>
               ...
               <div className="bg-rose-50/50 rounded-lg p-5 border border-rose-100">
                  <div className="flex items-center gap-2 mb-4">
                     <div className="bg-rose-500 p-1 rounded-full text-white"><X size={14} strokeWidth={4} /></div>
