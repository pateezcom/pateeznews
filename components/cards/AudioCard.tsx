      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[5px] p-6 shadow-xl border border-slate-700/50 relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="relative w-48 h-48 sm:w-56 sm:h-56 flex-shrink-0 my-2">
            ...
            <div
              className={`absolute top-0 left-0 w-full h-full rounded-[5px] bg-black border-4 border-gray-800 shadow-2xl flex items-center justify-center transition-all duration-700 ease-out z-0
                ${isPlaying ? 'translate-x-[25%] rotate-[360deg]' : 'translate-x-0 rotate-0'}
              `}
            >
              <div className="w-full h-full rounded-[5px] border-[12px] border-gray-900/50 relative flex items-center justify-center">
                <div className="absolute inset-0 border border-gray-800 rounded-[5px] opacity-40 m-4"></div>
                <div className="absolute inset-0 border border-gray-800 rounded-[5px] opacity-40 m-8"></div>
                <div className="w-16 h-16 bg-gradient-to-tr from-red-600 to-orange-500 rounded-[5px] flex items-center justify-center shadow-inner">
                  <div className="w-2 h-2 bg-black rounded-[5px]"></div>
                </div>
              </div>
            </div>
