...
const GalleryCard: React.FC<GalleryCardProps> = ({ data }) => {
  ...
  return (
    <div className="mt-4 space-y-4">
      ...
      <div className="relative bg-black rounded-2xl overflow-hidden shadow-lg group select-none aspect-[4/5] sm:aspect-square md:aspect-[4/3]">
        <div 
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10 p-1">
          <img 
            ...
            className="max-w-full max-h-full object-contain rounded-lg shadow-sm transition-all duration-500"
          />
        </div>
        <button 
          onClick={prevSlide}
          className="absolute left-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white/10 hover:bg-white/25 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center text-white transition-all opacity-0 group-hover:opacity-100 hover:scale-110"
        >
          <ChevronLeft size={24} />
        </button>
        <button 
          onClick={nextSlide}
          className="absolute right-3 top-1/2 -translate-y-1/2 z-20 w-10 h-10 bg-white/10 hover:bg-white/25 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center text-white transition-all opacity-0 group-hover:opacity-100 hover:scale-110"
        >
